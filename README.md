...
In the repository 'tests' you can find the codes for generating the numerical experiments in the paper and also the script 'test_HadDec' to try for small examples.
