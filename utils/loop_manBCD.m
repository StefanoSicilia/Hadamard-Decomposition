...
% the manifold Bmr. See HadDec for more details.
    ...
    % Update function
    if opts.noloops
        Upd_Manifold=@(W1,W2,G,hstep) UpdManifold_noloop(W1,W2,G,hstep);
    else
        Upd_Manifold=@(W1,W2,G,hstep) UpdManifold_loop(W1,W2,G,hstep);
    end
    ...
    if sparseflag
        ...
        while j<maxit && err(j)>tol && time(j)<maxtime
            ...
            for k=1:Iter_W
                ...
                G=Wy*A-B; 
                [W1y,W2y]=Upd_Manifold(W1y,W2y,G,stepw);
            end
            ...
            for k=1:Iter_H
                ...
                G=Hy*C-D;
                [H1y,H2y]=Upd_Manifold(H1y,H2y,G,steph);
            end
