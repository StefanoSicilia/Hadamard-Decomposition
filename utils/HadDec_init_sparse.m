function output=HadDec_init_sparse(X,r)
%% HadDec_init_sparse: All initializations for Hadamard decomposition
...
%
% Note: it works only if r^2>min(size(A)) and it is the sparse version of
% HadDec_all_init.
